    ...
    const check_valid = () => {
        if (vehicle_brand) {
            ...
            alt({
                ...
                title: strings.error,
                message: strings.please_enter_your_vehicle_brand,
              });
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>{strings.enter_your_vehicle_brand}</Text>
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>{strings.you_need_enter_your_vehicle_brand}</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
