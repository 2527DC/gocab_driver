        ...
        <View style={{ width: '80%' }}>
          ...
          {loading == false ?
            <TouchableOpacity onPress={check_valid.bind(this)} activeOpacity={1} style={{ width: '100%', backgroundColor: colors.btn_color, borderRadius: 10, height: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
              <Text style={{ color: colors.theme_fg_two, fontSize: f_m, color: colors.theme_fg_three, fontFamily: bold }}>{strings.login_register}</Text>
            </TouchableOpacity>
            :
      ...
      <View style={{ flexDirection: 'row' }}>
        ...
        <View style={{justifyContent: 'center', alignItems: 'flex-end' }}>
          <Picker
            ...
            itemStyle={{color: colors.theme_fg_two, fontFamily: normal }}
