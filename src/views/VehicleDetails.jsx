        ...
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <ScrollView>
                <View style={{ alignItems: 'center' }}>
                    <Text style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>{strings.add_your_vehicle}</Text>
                    <View style={{ margin: 20 }} />
                    <View style={{ width: '90%' }}>
                        <View style={{ marginBottom: 20 }}>
                            <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: bold }}>{strings.vehicle_name}</Text>
                            <View style={{ margin: 5 }} />
                            <TouchableOpacity activeOpacity={1} onPress={navigate.bind(this, 'CreateVehicleName')} style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ width: '85%', alignItems: 'flex-start', paddingLeft: 10, justifyContent: 'center', backgroundColor: colors.text_container_bg }}>
                                    <TextInput
                                        ...
                                        placeholder={strings.vehicle_name}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
                        <View style={{ marginBottom: 20 }}>
                            <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: bold }}>{strings.vehicle_brand}</Text>
                            <View style={{ margin: 5 }} />
                            <TouchableOpacity activeOpacity={1} onPress={navigate.bind(this, 'CreateVehicleBrand')} style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ width: '85%', alignItems: 'flex-start', paddingLeft: 10, justifyContent: 'center', backgroundColor: colors.text_container_bg }}>
                                    <TextInput
                                        ...
                                        placeholderTextColor={colors.grey}
                                        style={styles.textinput}
                                        placeholder={strings.vehicle_brand}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
                        <View style={{ marginBottom: 20 }}>
                            <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: bold }}>{strings.vehicle_color}</Text>
                            <View style={{ margin: 5 }} />
                        ...
                        <View style={{ marginBottom: 20 }}>
                            <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: bold }}>{strings.vehicle_number}</Text>
                            <View style={{ margin: 5 }} />
                            <TouchableOpacity activeOpacity={1} onPress={navigate.bind(this, 'CreateVehicleNumber')} style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ width: '85%', alignItems: 'flex-start', paddingLeft: 10, justifyContent: 'center', backgroundColor: colors.text_container_bg }}>
                                    <TextInput
                                        ...
                                        placeholderTextColor={colors.grey}
                                        style={styles.textinput}
                                        placeholder={strings.vehicle_number}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
                        <View style={{ marginBottom: 20 }}>
                            <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: bold }}>{strings.vehicle_type}</Text>
                            <View style={{ margin: 5 }} />
