    ...
    const check_valid = () => {
        if (vehicle_type) {
            ...
            alt({
                type: DropdownAlertType.Error,
                title: strings.validation_error,
                message: strings.please_select_your_vehicle_type,
            });
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>{strings.select_your_vehicle_type}</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
                    <FlatList
