        ...
        return (
            <View style={styles.animationHeader}>
                ...
                <View style={{ padding: 30, alignItems: 'center' }}>
                    <Text numberOfLines={2} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_30, letterSpacing: 1, fontFamily: bold, textAlign: 'center' }}>{strings.how_can_we_help_you}</Text>
                </View>
            </View>
        )
    }
        ...
        <View style={styles.container}>
            ...
            <Animated.View opacity={headerHeight} style={[styles.header]}>
                ...
                <TouchableOpacity style={{ width: '83%', alignItems: 'flex-start', justifyContent: 'center' }}>
                    <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontFamily: bold }}>{strings.faqs}</Text>
                </TouchableOpacity>
            </Animated.View>
        </View>
    );
