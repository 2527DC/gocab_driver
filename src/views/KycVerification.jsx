  ...
  const check_validation = () => {
    if (bank_name == "" || account_number == "" || ifsc_code == "" || aadhar_number == "" || pan_number == "") {
      alt({
        type: DropdownAlertType.Error,
        title: strings.validation_error,
        message: strings.please_fill_required_field,
      });
    ...
    axios({
      ...
      .then(async response => {
        ...
        alt({
          ...
          message: strings.your_bank_name_has_been_updated,
        });
  ...
  return (
    <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
      ...
      <View style={[styles.header]}>
        ...
        <View activeOpacity={1} style={{ width: '90%', alignItems: 'flex-start', justifyContent: 'center' }}>
          <Text numberOfLines={2} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontFamily: bold }}>{strings.update_your_bank_details}</Text>
        </View>
      </View>
      <ScrollView>
        {on_load == 1 &&
