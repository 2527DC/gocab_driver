    ...
    <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
      ...
      <View style={[styles.header]}>
        ...
        <View activeOpacity={1} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
          <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontFamily: bold }}>{strings.trip_settings}</Text>
        </View>
      </View>
      <View style={{ backgroundColor: colors.theme_bg_three, padding: 10, margin: 10, borderRadius: 10, borderWidth:1, borderColor: colors.theme_bg }}>
        <View style={{ flexDirection:'row', width:'100%', padding:10}}>
          <View style={{width:'70%'}}>
              <Text style={{ fontFamily:bold, fontSize:18, color:colors.theme_fg_two}}>{strings.enable_shared_ride_status}</Text>
          </View>
          <View style={{width:'30%'}}>
            <Switch
