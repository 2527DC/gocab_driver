            ...
            .then(async response => {
                ...
                if (response.data.status == 1) {
                    ...
                    alt({
                        ...
                        message: strings.amount_successfully_added_to_your_wallet,
                      });
                        ...
                        <View style={{ width: '100%', backgroundColor: colors.theme_bg_three, borderRadius: 10, padding: 20 }}>
                            <View style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ width: '55%', alignItems: 'flex-start', justifyContent: 'center' }}>
                                    <Text numberOfLines={2} ellipsizeMode='tail' style={{ color: colors.text_grey, fontSize: f_s, fontFamily: normal }}>{strings.total_wallet_balance}</Text>
                                </View>
